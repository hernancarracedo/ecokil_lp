...
// controlador
const monitoreoController = require('../controllers/monitoreo');
...
router.post('/monitoreo/create', monitoreoController.createMonitoreos);
router.get('/monitoreo/:id', monitoreoController.getMonitoreos);
